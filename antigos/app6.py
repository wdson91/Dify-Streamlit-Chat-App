...
def chat_page():
    ...
    if not st.session_state.messages:
        welcome_message = f"Olá {st.session_state.username}, Sou um assistente virtual especializado em agendamentos de reuniões na empresa XYZ. Estou aqui para ajudá-lo a gerenciar seus compromissos de forma eficiente, gerenciando reuniões conforme a sua necessidade."
